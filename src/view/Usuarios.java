...
public class Usuarios extends JDialog {
	...
	public Usuarios() {
		...
		scrollPaneUsers.setVisible(false);
		scrollPaneUsers.setBounds(12, 60, 177, 37);
		...
		txtNome.setBounds(12, 30, 177, 32);
		getContentPane().add(txtNome);
		txtNome.setColumns(10);
		txtNome.setDocument(new Validador(50));

		JLabel lblSenha = new JLabel("SENHA:");
		lblSenha.setBounds(12, 145, 46, 14);
		...
		lblLock.setBounds(49, 143, 16, 16);
		getContentPane().add(lblLock);

		JLabel lblID = new JLabel("ID:");
		lblID.setBounds(324, 11, 46, 14);
		getContentPane().add(lblID);

		txtID = new JTextField();
		txtID.setEditable(false);
		txtID.setBounds(324, 26, 89, 32);
		getContentPane().add(txtID);
		txtID.setColumns(10);

		JLabel lblNome = new JLabel("NOME DE USUÁRIO:");
		lblNome.setBounds(11, 11, 236, 14);
		...
		txtLogin.setBounds(12, 102, 235, 34);
		...
		panel.setBounds(0, 248, 480, 98);
		getContentPane().add(panel);
		panel.setLayout(null);

		btnPesquisar = new JButton("");
		btnPesquisar.setContentAreaFilled(false);
		btnPesquisar.setBounds(199, 11, 48, 48);
		...
		btnAdicionar.setBounds(267, 98, 48, 48);
		...
		btnEditar.setBounds(352, 96, 48, 48);
		...
		btnApagar.setBounds(267, 157, 48, 48);
		...
		btnExcluir.setBounds(351, 155, 48, 48);
		getContentPane().add(btnExcluir);
		
		cboPerfil = new JComboBox();
		cboPerfil.setModel(new DefaultComboBoxModel(new String[] {" ", "Admin", "User"}));
		cboPerfil.setBounds(257, 25, 57, 34);
		getContentPane().add(cboPerfil);
		
		lblPerfil = new JLabel("PERFIL:");
		lblPerfil.setBounds(257, 11, 46, 14);
		...
		getContentPane().add(checkSenha);
				...
				lblLogin.setBounds(12, 83, 46, 14);
